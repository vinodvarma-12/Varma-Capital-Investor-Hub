      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        >
          ...
          <p className="text-foreground/75 max-w-lg mx-auto text-sm leading-relaxed">
            ...
            You&apos;ll see your live dashboard here as soon as everything is
            ready — no action needed on your side.
          </p>
        </div>
            ...
            {embedUrl ? (
              ...
              <div className="aspect-video flex flex-col items-center justify-center gap-3 bg-muted px-6 text-center">
                ...
                <p className="text-muted-foreground text-xs max-w-sm">
                  Your Varma Capital welcome video will appear here once
                  configured.
                </p>
              </div>
            )}
          ...
          <CardContent className="p-6 space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-foreground/75 leading-relaxed">
                  ...
                  will automatically switch to your full dashboard once
                  that&apos;s complete.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-foreground/75 leading-relaxed">
                  Explore the welcome video above, update your profile under
                  Settings, or reach out via Support if you have questions.
                </p>
              </div>
            </div>
