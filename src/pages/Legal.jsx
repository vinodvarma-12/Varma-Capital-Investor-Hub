    ...
    <div className="min-h-screen bg-black p-6">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Tabs defaultValue={initialTab} className="w-full">
          <TabsList className="grid w-full grid-cols-3 border border-[#ccab6c]/30 bg-zinc-950">
          ...
          <TabsContent value="privacy">
            <Card className="bg-zinc-950 border border-[#ccab6c]/30">
              <CardContent className="p-8 prose prose-invert max-w-none">
                ...
                <p className="text-zinc-300">We do not sell your information. We only share it with:</p>
                <ul className="text-zinc-300 space-y-2">
          ...
          <TabsContent value="risk">
            <Card className="bg-zinc-950 border border-[#ccab6c]/30">
              <CardContent className="p-8 prose prose-invert max-w-none">
                ...
                <p className="text-zinc-300">Performance shown on the Portal may include:</p>
                <ul className="text-zinc-300 space-y-2">
